...
Deno.serve(async (request) => {
  ...
  try {
    ...
    // Deno Deploy 缓存 API - 使用 caches.open()
    ...
    const fetchOptions = {
      ...
      headers: {
        'User-Agent': 'TellusCN-Deno-Deploy/1.0 (Minecraft Mod Proxy)',
